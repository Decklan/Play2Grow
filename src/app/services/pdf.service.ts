...
export class PdfService {
  ...
  createPdfLinks() {
    ...
    this.pdfs.push(new PdfLink('Client Information and Insurance', "../../../assets/pdfs/Client_Information_and_Insurance_Intake_Form_2016.pdf"));
    this.pdfs.push(new PdfLink('Authorization to Request Information', "../../../assets/pdfs/Authorization_to_Request_Information_2016.pdf"));
